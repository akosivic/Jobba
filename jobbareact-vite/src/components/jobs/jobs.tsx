import { Button, ButtonGroup, Card, Col, Container, Dropdown, DropdownButton, ListGroup, Row, Stack } from "react-bootstrap";
        ...
        <>
            <div className="container my-5">
                ...
                <Stack direction="horizontal" gap={3} className="mb-2" >
                    ...
                    <DropdownButton variant="outline-dark" id="dropdown-basic-button" size="sm" title="Sort by">
